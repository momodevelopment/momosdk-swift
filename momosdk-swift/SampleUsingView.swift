...
//  MomoiOSSwiftSdkV2
//  Github https://github.com/momo-wallet/mobile-sdk/tree/master/ios
...
class PaymentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        paymentinfo["appScheme"] = "partnerscheme001" //<partnerSchemeId>: app uniqueueId provided by MoMo , get from business.momo.vn. PLEASE MAKE SURE TO ADD <partnerSchemeId> TO PLIST file ( URL types > URL Schemes ). View more detail on https://github.com/momo-wallet/mobile-sdk/tree/master/ios
    ...
    @objc func gettoken() {
        MoMoPayment.sharedInstance.requestToken()
    }
